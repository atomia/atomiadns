...
%{__cat} > %{buildroot}/etc/yum.repos.d/atomia-rhel7.repo <<EOF
[atomia]
name=Atomia RHEL7 RPM Repository
baseurl=http://rpm.atomia.com/rhel7/
enabled=1
gpgcheck=1
...
/etc/yum.repos.d/atomia-rhel7.repo
