...
%{__cat} > %{buildroot}/etc/yum.repos.d/atomia-rhel9.repo <<EOF
[atomia]
name=Atomia RHEL9 RPM Repository
baseurl=http://rpm.atomia.com/rhel9/
enabled=1
gpgcheck=1
...
/etc/yum.repos.d/atomia-rhel9.repo
