...
%{__cat} > %{buildroot}/etc/yum.repos.d/atomia-rhel8.repo <<EOF
[atomia]
name=Atomia RHEL8 RPM Repository
baseurl=http://rpm.atomia.com/rhel8/
enabled=1
gpgcheck=1
...
/etc/yum.repos.d/atomia-rhel8.repo

%post
rpm --import /etc/pki/rpm-gpg/RPM-GPG-KEY-ATOMIA

%changelog
* Mon Mar 06 2023 Nikola Vitanovic <nikola.vitanovic@atomia.com> - 1.0
- Initial RPM package.
