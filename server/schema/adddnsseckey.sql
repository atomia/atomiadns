...
BEGIN
	IF NOT k_algorithm IN ('RSASHA1', 'RSASHA256', 'RSASHA512') THEN
		RAISE EXCEPTION 'algorithm % is unknown, we support RSASHA1, RSASHA256 and RSASHA512', k_algorithm;
	ELSIF NOT ((k_algorithm = 'RSASHA512' AND k_keysize BETWEEN 1024 AND 4096) OR k_keysize BETWEEN 512 AND 4096) THEN
